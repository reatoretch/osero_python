...
class GUIPlayer():
    ...
    def nextHand(self,osero):
        ...
        while True:
            ...
            if osero.availables[osero.turn][(self.x,self.y)]:return self.x,self.y
    ...
    def nextHand(self,osero):
        ...
        #for x,y in avail:
            ...
            for _ in range(30):
                ...
                nowGame.players=[AI(hand=osero.game.BLACK),AI(hand=osero.game.WHITE)]
                while True:
                    if nowGame.run():
                        #nowGame.game.show()
                        winCnt+=nowGame.cnt[self.hand]>nowGame.cnt[(self.hand+1)%2]
                        break
